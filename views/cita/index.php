<h1 class="nombre-pagina">CREAR UN CITA</h1>
<p class="descripcion-pagina">Elige tus servcios y coloca tus datos</p>  
...
<div id="app">
    ...
    <div id="paso-3" class="seccion contenido-resumen">
        <h2>Resumen</h2>
        <p>Verifica que la información este correcta</p>
